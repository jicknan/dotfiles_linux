...
set ethaddr 00:c0:02:00:c0:66; set serverip 172.21.6.15; set ipaddr 172.21.6.77; tftpboot 0x400000 uImage; bootm 0x400000
set ethaddr 00:c0:02:00:c0:66; set serverip 192.168.0.2; set ipaddr 192.168.0.40; tftpboot 0x400000 uImage; bootm 0x400000
...
set bootargs console=ttyS0,115200 root=/dev/ram0; set serverip 172.21.6.133; set ipaddr 172.21.6.77; tftpboot 0x400000 uImage-2.6.26.2-r0-ts209-initramfs.bin; bootm 0x400000
